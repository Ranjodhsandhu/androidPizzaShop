...
public class Calzones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Calzones.this,MainActivity.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getUserSelection();
                loginDataBaseAdapter.addOrder("Calzones",orderDesc,username);
                Toast.makeText(Calzones.this,"Item Added with "+orderDesc,Toast.LENGTH_LONG).show();
                Intent intent2 = new Intent(Calzones.this,MainActivity.class);
    ...
    public void getUserSelection(){
        ...
        Toast.makeText(Calzones.this, "Desc "+orderDesc, Toast.LENGTH_SHORT).show();
